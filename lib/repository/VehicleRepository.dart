...
class VehicleRepository {
  ...
  static void buyVehicle(VehicleFeatures vehicle) async {
    ...
    //List<String> vehicleAvailable = (preferences.getStringList(vehicleKey) ?? List<String>()); (Deprecated)
    List<String> vehicleAvailable =
        (preferences.getStringList(vehicleKey) ?? []);
  ...
  static Future<List<VehicleFeatures>> getPurchasedVehicles() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    //List<VehicleFeatures> features = new List<VehicleFeatures>(); (Deprecated)
    ...
    // List<String> vehicleAvailable =
    //     (preferences.getStringList(vehicleKey) ?? List<String>()); (Deprecated)
    List<String> vehicleAvailable =
        (preferences.getStringList(vehicleKey) ?? []);
