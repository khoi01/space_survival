...
class ElectricBullet extends Weapon{
  ...
  ElectricBullet(SpaceSurvivalGame game,String  targetComet,double x,double y, double widthComponent, double heightComponent) : super(game,targetComet, widthComponent, heightComponent){
